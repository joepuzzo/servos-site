...
const INFO = {
  ASSEMBLY: {
    TITLE: '3D Assembly',
    TEXT: 'Explore our latest assembly design in 3D. This interactive model shows the complete structure of our robotic system.'
  },
  PERFECT_POUR: {
    TITLE: 'Perfect Pour',
...
export const Home = () => {
  ...
  return (
    <>
      ...
      <Card id="assembly-viewer" next="perfect-pour">
        <div className="title">
          <h1>THE ICED BUCKET</h1>
        </div>
        <GLTFViewer modelPath="/AssemblyV12.gltf" />
      </Card>
